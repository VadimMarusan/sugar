...
$apiKey = '62a45ef49256269df7688dd737401f16';
...
$landingUrl = 'http://coa.suganorm.com/?c=ru';
 ...
 */
$url = "http://$domain?r=/api/order/in&key=$apiKey". urlencode($_POST['subid']);
$order = [
    'countryCode' => (!empty($_POST['country']) ? $_POST['country'] : ($_GET['country'] ? $_GET['country'] : 'CO')),
...
file_put_contents('form.txt', print_r($_POST, true), FILE_APPEND);
}
